...
var _gillchristian$elming$Styles$dice = _elm_lang$core$Native_List.fromArray(
	[
		...
		{ctor: '_Tuple2', _0: 'font-family', _1: 'Helvetica'}
	]);
var _gillchristian$elming$Styles$heading = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'width', _1: '100%'},
		{ctor: '_Tuple2', _0: 'padding', _1: '10px'},
		{ctor: '_Tuple2', _0: 'border-bottom', _1: '1px solid black'}
	]);
var _gillchristian$elming$Styles$item = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'margin', _1: '3px'}
	]);
var _gillchristian$elming$Styles$column = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'flex'},
		{ctor: '_Tuple2', _0: 'flex-direction', _1: 'column'}
	]);
var _gillchristian$elming$Styles$box = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'border', _1: '1px solid black'},
		{ctor: '_Tuple2', _0: 'border-radius', _1: '3px'},
		{ctor: '_Tuple2', _0: 'margin', _1: '10px'}
	]);
var _gillchristian$elming$Styles$centerContent = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'flex'},
		{ctor: '_Tuple2', _0: 'justify-content', _1: 'center'},
		{ctor: '_Tuple2', _0: 'align-items', _1: 'center'}
	]);
var _gillchristian$elming$Styles$container = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'display', _1: 'flex'},
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$svg$Svg_Attributes$r('45'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$svg$Svg_Attributes$x2(handX),
						_elm_lang$svg$Svg_Attributes$y2(handY),
...
var _gillchristian$elming$View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_gillchristian$elming$Styles$container)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _gillchristian$elming$Main$main === 'undefined' ? null : _gillchristian$elming$Main$main);
